...
create database pia;
use pia;
CREATE TABLE user  (iduser INT AUTO_INCREMENT PRIMARY KEY, email VARCHAR(30), username VARCHAR(45) NOT NULL, password VARCHAR(16) NOT NULL);
CREATE TABLE video (idvideo INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(45) NOT NULL, artist VARCHAR(45) NOT NULL, videoPath VARCHAR(45) NOT NULL, imagePath VARCHAR(45) NOT NULL);
#+end_src
